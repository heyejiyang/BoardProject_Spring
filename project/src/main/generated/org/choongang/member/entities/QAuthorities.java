...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    public final EnumPath<com.heyeji.boot.member.constants.Authority> authority = createEnum("authority", com.heyeji.boot.member.constants.Authority.class);

    public final com.heyeji.boot.member.entities.QMember member;
    ...
    public QAuthorities(Class<? extends Authorities> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.heyeji.boot.member.entities.QMember(forProperty("member")) : null;
    }
